...
public class  FCTSupportManageController {
	...
	@RequestMapping(value = "/module/amrscomplexobs/manage.form", method = RequestMethod.GET)
    ...
    @RequestMapping(method=RequestMethod.POST, value="module/amrscomplexobs/manage.form")
